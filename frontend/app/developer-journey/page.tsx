...
export default function DeveloperPage() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white selection:bg-cyan-500/30 overflow-x-hidden font-sans antialiased">
        ...
        <div className="z-10 flex flex-col md:flex-row md:items-center w-full gap-10 md:gap-20">
          ...
          >
            ...
            <h1 className="text-[14vw] md:text-[8vw] font-black leading-[0.85] tracking-tighter uppercase italic mb-8">
              BUILDING APP <br/> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">LOGIC.</span>
            </h1>
...
/>
      ...
      <section className="py-20 px-8 md:px-20 max-w-[1600px] mx-auto opacity-40 hover:opacity-100 transition-opacity duration-700">
        <div className="border border-cyan-500/20 rounded-[3rem] p-10 bg-gradient-to-br from-[#0a0a0a] to-black">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            ...
            <div className="h-[1px] w-12 bg-cyan-900/40 hidden md:block align-middle mt-4" />
            <div className="space-y-1 max-w-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {learningProjects.map((mini, i) => (
            <motion.div
              key={mini.name}
              whileHover={{ x: 8 }}
              className="p-8 border border-white/5 bg-[#080808] rounded-2xl group hover:bg-white/[0.01] transition-all flex flex-col justify-between h-48 border-l-2 border-l-gray-900 hover:border-l-cyan-400"
            >
